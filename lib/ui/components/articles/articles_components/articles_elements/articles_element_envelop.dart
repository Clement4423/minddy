...
class ArticlesElemementEnvelop extends StatefulWidget {
  ...
  const ArticlesElemementEnvelop({
    required this.child,
  ...
  @override
  State<ArticlesElemementEnvelop> createState() => _ArticlesElemementEnvelopState();
}

class _ArticlesElemementEnvelopState extends State<ArticlesElemementEnvelop> {  
