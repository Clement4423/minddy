...
import 'package:minddy/ui/components/custom_elements/custom_password_text_field.dart';
...
class UnlockSubMenu extends StatefulWidget {
  const UnlockSubMenu({super.key, required this.controller});

  final UnlockSubMenuController controller;

  @override
  State<UnlockSubMenu> createState() => _UnlockSubMenuState();
}

class _UnlockSubMenuState extends State<UnlockSubMenu> {
