                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: IconButton(
                      ...
                      style: ButtonStyle(
                        iconColor: MaterialStatePropertyAll(theme.onSecondary),
                        backgroundColor: MaterialStatePropertyAll(theme.secondary),
                        iconSize: const MaterialStatePropertyAll(40),
                        elevation: const MaterialStatePropertyAll(7),
                        shadowColor: MaterialStatePropertyAll(theme.shadow),
                      ),
                    ),
                  ),
                  if (kDebugMode)
